...
<script type="text/javascript"
	src="${ContextPath}/houseWork/houseWorkDispatchMessage.js"></script>
<script type="text/javascript"
							...
							<form id="myForm1" class="form-horizontal" role="form">
								...
								<fieldset id="basicInfo">
									...
									<div class="form-group form-group-sm ">
										...
										<div class="col-sm-11">
											<textarea rows="3" id="other" style="height: 60px"
								...
								<div class="modal-footer">
									<button id="btAssigenAdd" onclick="openSaveButton()"
										class="btn btn-primary " type="button">保存</button>
									<button id="btAssigenHandle" onclick="openHandleButton()"
										class="btn btn-primary " type="button">派工</button>
									<button id="btHouseworkdelete" onclick="openQxButton()"
										class="btn btn-primary " type="button">取消工单</button>
								</div>
