...
<script type="text/javascript"
	src="${ContextPath}/houseWork/houseWorkDispatch.js"></script>
<script type="text/javascript"
		...
		<div
			...
			<div class="row">
				<div class="col-md-6" style="float: left; margin-top: 10px;"
					id="topToolbar">
					<!-- 		   		  <button id="btn1" onclick="openButtonWindow(1)" class="btn btn-primary " disabled type="button"><i class="fa fa-plus"></i>&nbsp;处理</button> -->
								...
								<form id="myForm1" class="form-horizontal" role="form">
									...
									<fieldset id="basicInfo">
										...
										<div class="form-group form-group-sm ">
											...
											<label class="col-sm-1 control-label">受理人</label>
											<div class="col-sm-3">
												<input class="form-control" id="verify_oper_id"
													type="hidden" readonly="readonly" disabled="disabled" /> <input
													class="form-control" id="verify_oper_name" type="text"
													readonly="readonly" />
											</div>
											...
											<div class="col-sm-3">
												<div class="input-group">
													<input type="text" class="form-control"
														...
														class="form-control validate[required]"
														placeholder="请输入部门名称" id="comp_operator_username"
										...
										<div class="form-group form-group-sm ">
											...
											<div class="col-sm-3">
												<input
													...
													onclick="laydate.render({type:'datetime'})"
