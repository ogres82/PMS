...
<script type="text/javascript" src="${ContextPath}/secManage/tsecuritychargerduty.js"></script>
    ...
    <div class="wrapper wrapper-content">
		...
		<!-- 弹出窗口区域，触发事件后弹出  -->
		 ...
		 <div class="modal-header" style="background:#18a689">
							...
							<h4 class="modal-title" id="myModalTitle" style="color:white">查看</h4>
		 </div>
		          		...
		          		<div id="tab-1" class="tab-pane active">
		          			<form id="myForm1" class="form-horizontal" role="form">
								...
								<legend style="font-size:15px;border:0;"></legend>
									   ...
									   <div class="form-group form-group-sm ">
											  <label class="col-sm-1 control-label">当班主管</label>
											  <div class="col-sm-3">
											     <select class="form-control validate[required]" id="shiftPasserId" disabled="disabled"> 
														  <option value="">---请选择---</option>
												  </select>
											  </div>
											  <label class="col-sm-1 control-label" >接班标识</label>
											  <div class="col-sm-3">
											  ...
											  <label class="col-sm-1 control-label" >当值人数</label>
											  <div class="col-sm-3">
													<input class="form-control validate[required,custom[number]]  " id="shiftDutyNum" type="text" placeholder="必填项"/>
											  </div>
											  
									   </div>
									   <div id="jiebancase" class="form-group form-group-sm ">
											  <label class="col-sm-1 control-label" >接班情况</label>
											  <div class="col-sm-7">
											      <textarea class="form-control validate[required] " rows="6" id="shiftTakeCase" style="height:60px"></textarea>
											  	  <!-- <input class="form-control validate[required]" id="shiftDutyList" type="text" /> -->
											  </div>
									   ...
									   <div class="form-group form-group-sm ">
									       <label class="col-sm-1 control-label" >值班人员名单</label>
											  <div class="col-sm-11">
											      <textarea class="form-control validate[required] " rows="6" id="shiftDutyList" style="height:60px"></textarea>
											  	  <!-- <input class="form-control validate[required]" id="shiftDutyList" type="text" /> -->
											  </div>
									   </div>
									   <div class="form-group form-group-sm ">
									       <label class="col-sm-1 control-label" >休息/请假人员</label>
											  <div class="col-sm-11">
											      <textarea class="form-control validate[required] " rows="6" id="shiftDutyVocate" style="height:60px"></textarea>
											  	  <!-- <input class="form-control validate[required]" id="shiftDutyList" type="text" /> -->
											  </div>
									   </div>
									   <div class="form-group form-group-sm ">
									       <label class="col-sm-1 control-label">员工表现</label>
											  <div class="col-sm-11">
											      <textarea class="form-control validate[required] " rows="6" id="shiftDutyPerform" style="height:60px"></textarea>
											  	  <!-- <input class="form-control validate[required]" id="shiftDutyList" type="text" /> -->
											  </div>
									   </div>
									   <div class="form-group form-group-sm ">
											  <label class="col-sm-1 control-label" >物品移交</label>
											  <div class="col-sm-11">
											      <textarea class="form-control validate[required] " rows="9" id="shiftGoodsTransfer" style="height:100px"></textarea>
											  	  <!-- <input class="form-control validate[required]" id="shiftDutyList" type="text" /> -->
											  </div>
									   </div>
									   <div class="form-group form-group-sm ">
											  <label class="col-sm-1 control-label" >当班情况</label>
											  <div class="col-sm-11">
											      <textarea class="form-control validate[required] " rows="6" id="shiftDutyCase" style="height:60px"></textarea>
											  	  <!-- <input class="form-control validate[required]" id="shiftDutyList" type="text" /> -->
											  </div>
									   </div>
									   <div class="form-group form-group-sm ">
											  <label class="col-sm-1 control-label" >交班情况</label>
											  <div class="col-sm-11">
									   ...
									   <div class="form-group form-group-sm">
											  ...
											  <label class="col-sm-1 control-label">接班主管</label>
											  <div class="col-sm-5">
