...
$(function () {
    ...
    oTable.Init();
    $(".summernote").summernote({lang:"zh-CN",height: 200});
    initAuditors();
	layer.config({
...
var TableInit = function (){
	...
	oTableInit.Init = function (){
		$('#chargeInfo').bootstrapTable({
			url: './../msgandnotice/msgtemp.app?method=listTemp',         //请求后台的URL（*）
