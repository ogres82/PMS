...
<script type="text/javascript" src="${ContextPath}/assertStockManage/instockvoucher.js">
</script>
...
<body class="gray-bg">
      <div class="wrapper wrapper-content">
	    	...
	    	<div class ="ibox float-e-margins" style="text-align:center;margin-left:auto;margin-right:auto;">
				<div class="ibox-content col-md-12 b-r">
					<form class="form-horizontal" id="orderForm">
						<div class="form-group" style="margin-top:20px;">
							<label class="col-md-1 control-label">单据编码</label>
							<div class="col-md-3">
								<input type="text"  class="form-control" id="voucher_code" readonly="readonly"> 
							</div>
							<label class="col-md-1 control-label">发生日期</label>
							<div class="col-md-3">
								<input type="text" class="form-control" id="occurren_date" readonly="readonly"/>
							</div>
							<label class="col-md-1 control-label">所属库存</label>
							<div class="col-md-3">
								<select class="form-control validate[required]" id="owne_stock" disabled="disabled"> 
								</select>  
							</div>
						</div>
						<div class="form-group" style="margin-top:20px;">
							...
							<div class="col-sm-3">
							<select class="form-control validate[required]" id="suppliy_code"> 
