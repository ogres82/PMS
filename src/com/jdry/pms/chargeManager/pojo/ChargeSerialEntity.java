...
@Entity
@Table(name = "t_charge_serial_info")
public class ChargeSerialEntity implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4515962084449310650L;
	...
	private Date update_date = new Date(); // 更新时间
	private int delete_id = 0; // 删除标识，只是逻辑删除 0：未删除，1：已删除
