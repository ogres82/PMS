...
public class VEmp {
	...
	int empContractRemain; // 合同剩余天数
	String empContractMark; // 合同到期提醒
	// 社保关系
	...
	String empBirthMon;
	String empAgeGroup;
	String empWorkAge1; // 工龄 导出excel使用
	String empPositionLevlName;// 职能层级 导出excel使用
	String empTechLevlName; // 技术级别 导出excel使用
	String empRegularizeName; // 转正情况 导出excel使用
	String empEduFullTime1; // 是否全日制 导出excel使用
	String empCertifiScan1; // 是否有扫描件 导出excel使用
	String empEmployTypeName; // 用工类型 导出excel使用
	String empMarriageName; // 婚否 导出excel使用
	String empBearName; // 生育否 导出excel使用
	String empResidenceName; // 住宿 导出excel使用
	String empFullwagesFlag1; // 转正体现 导出excel使用
	String empEducationName; // 学历 导出excel使用
	Date curDate; // 当前时间 导出excel使用
	String empLaborStatus1;
	String empLaborStatus2;
	String empLaborStatus3;
	String empLaborStatus4;
	String empLaborStatus5;
	String empLaborStatus6;
	...
	// }
	//
	// public void setEmpNp(String empNp){
	// this.empNp = empNp;
	// }
	...
	public void setEmpPhoto(String empContactInfo) {
		this.empContactInfo = empContactInfo;
	}
	...
	@Column(name = "emp_work_age")
	public String getEmpWorkAge() {
		return this.empWorkAge;
	}

	public void setEmpWorkAge(String empWorkAge) {
		this.empWorkAge = empWorkAge;
	}
	...
	@Column(name = "emp_contract_remain")
	public int getEmpContractRemain() {
		return this.empContractRemain;
	}

	public void setEmpContractRemain(int empContractRemain) {
		this.empContractRemain = empContractRemain;
	}

	@Column(name = "emp_contract_mark")
	public String getEmpContractMark() {
		return this.empContractMark;
	}

	public void setEmpContractMark(String empContractMark) {
		this.empContractMark = empContractMark;
	}
	...
	@Column(name = "emp_work_unit")
	public String getEmpWorkUnit() {
		return empWorkUnit;
	}

	public void setEmpWorkUnit(String empWorkUnit) {
		this.empWorkUnit = empWorkUnit;
	}

	@Column(name = "emp_birth_mon")
	public String getEmpBirthMon() {
		return empBirthMon;
	}

	public void setEmpBirthMon(String empBirthMon) {
		this.empBirthMon = empBirthMon;
	}

	@Column(name = "emp_age_group")
	public String getEmpAgeGroup() {
		return empAgeGroup;
	}

	public void setEmpAgeGroup(String empAgeGroup) {
		this.empAgeGroup = empAgeGroup;
	}

	@Column(name = "emp_work_age1")
	public String getEmpWorkAge1() {
		return empWorkAge1;
	}

	public void setEmpWorkAge1(String empWorkAge1) {
		this.empWorkAge1 = empWorkAge1;
	}

	@Column(name = "emp_position_levl_name")
	public String getEmpPositionLevlName() {
		return empPositionLevlName;
	}

	public void setEmpPositionLevlName(String empPositionLevlName) {
		this.empPositionLevlName = empPositionLevlName;
	}

	@Column(name = "emp_tech_levl_name")
	public String getEmpTechLevlName() {
		return empTechLevlName;
	}

	public void setEmpTechLevlName(String empTechLevlName) {
		this.empTechLevlName = empTechLevlName;
	}

	@Column(name = "emp_regularize_name")
	public String getEmpRegularizeName() {
		return empRegularizeName;
	}

	public void setEmpRegularizeName(String empRegularizeName) {
		this.empRegularizeName = empRegularizeName;
	}

	@Column(name = "emp_edu_full_time1")
	public String getEmpEduFullTime1() {
		return empEduFullTime1;
	}

	public void setEmpEduFullTime1(String empEduFullTime1) {
		this.empEduFullTime1 = empEduFullTime1;
	}

	@Column(name = "emp_certifi_scan1")
	public String getEmpCertifiScan1() {
		return empCertifiScan1;
	}

	public void setEmpCertifiScan1(String empCertifiScan1) {
		this.empCertifiScan1 = empCertifiScan1;
	}

	@Column(name = "emp_employ_type_name")
	public String getEmpEmployTypeName() {
		return empEmployTypeName;
	}

	public void setEmpEmployTypeName(String empEmployTypeName) {
		this.empEmployTypeName = empEmployTypeName;
	}
	...
	@Column(name = "emp_bear_name")
	public String getEmpBearName() {
		return empBearName;
	}

	public void setEmpBearName(String empBearName) {
		this.empBearName = empBearName;
	}

	@Column(name = "emp_residence_name")
	public String getEmpResidenceName() {
		return empResidenceName;
	}

	public void setEmpResidenceName(String empResidenceName) {
		this.empResidenceName = empResidenceName;
	}

	@Column(name = "emp_fullwages_flag1")
	public String getEmpFullwagesFlag1() {
		return empFullwagesFlag1;
	}

	public void setEmpFullwagesFlag1(String empFullwagesFlag1) {
		this.empFullwagesFlag1 = empFullwagesFlag1;
	}

	@Column(name = "emp_education_name")
	public String getEmpEducationName() {
		return empEducationName;
	}

	public void setEmpEducationName(String empEducationName) {
		this.empEducationName = empEducationName;
	}
	...
	@Column(name = "emp_labor_status1")
	public String getEmpLaborStatus1() {
		return empLaborStatus1;
	}

	public void setEmpLaborStatus1(String empLaborStatus1) {
		this.empLaborStatus1 = empLaborStatus1;
	}

	@Column(name = "emp_labor_status2")
	public String getEmpLaborStatus2() {
		return empLaborStatus2;
	}

	public void setEmpLaborStatus2(String empLaborStatus2) {
		this.empLaborStatus2 = empLaborStatus2;
	}

	@Column(name = "emp_labor_status3")
	public String getEmpLaborStatus3() {
		return empLaborStatus3;
	}

	public void setEmpLaborStatus3(String empLaborStatus3) {
		this.empLaborStatus3 = empLaborStatus3;
	}

	@Column(name = "emp_labor_status4")
	public String getEmpLaborStatus4() {
		return empLaborStatus4;
	}

	public void setEmpLaborStatus4(String empLaborStatus4) {
		this.empLaborStatus4 = empLaborStatus4;
	}

	@Column(name = "emp_labor_status5")
	public String getEmpLaborStatus5() {
		return empLaborStatus5;
	}

	public void setEmpLaborStatus5(String empLaborStatus5) {
		this.empLaborStatus5 = empLaborStatus5;
	}

	@Column(name = "emp_labor_status6")
	public String getEmpLaborStatus6() {
		return empLaborStatus6;
	}

	public void setEmpLaborStatus6(String empLaborStatus6) {
		this.empLaborStatus6 = empLaborStatus6;
	}
}