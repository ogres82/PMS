...
<script type="text/javascript" src="${ContextPath}/advertiseManager/AdvAttachInfoList.js"></script>
	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>广告位附属信息<small></small></h5>
	                        
	                    </div>
	                    <div class="ibox-content" id="tempTable">
	                    	<div id="toolbar"></div>
							<table class="table-no-bordered" id="attachInfo"></table>	
								...
								<legend style="font-size:15px;border:0;"></legend>
								 	<div class="form-group form-group-sm ">
									    	 <label class="col-sm-2 control-label">广告商</label>
											  ...
											  <label class="col-sm-2 control-label" >广告商电话</label>
											  <div class="col-sm-4">
										...
										<div class="form-group form-group-sm ">
											  ...
											  <div class="col-sm-4">
													<select class="form-control validate[required]" id="adv_pos_code"> 
													  <option value="">---请选择---</option>
													</select>
											  </div>
											  <label class="col-sm-2 control-label">合同编号</label>
											  <div class="col-sm-4">
													<input class="form-control" id="contract_code" type="text" />
											  </div>			  
									   </div>
									   <div class="form-group form-group-sm ">
									   ...
									   <input class="form-control" id="p_id" type="hidden" />
								  </fieldset>
