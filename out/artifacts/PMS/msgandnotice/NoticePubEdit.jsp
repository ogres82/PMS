				  ...
				  <div class="modal-body">
					<form id="myForm" class="form-horizontal" action="${ContextPath}/msgandnotice/list.app?method=save" method="post">
						  <div class="form-group form-group-sm ">
							  ...
							  <div class="col-sm-4">
								 <input class="form-control" name="ntcSubject" id="ntcSubject" type="text"/>
							  </div>
							  <label class="col-sm-2 control-label">审核人</label>
							  <div class="col-sm-4">
								 <input class="form-control" name="ntcAudit" id="ntcAudit" type="text" />
							  </div>
						   </div>
						   <div class="form-group form-group-sm ">
						   ...
						   <div class="form-group form-group-sm ">
							  ...
							  <div class="col-sm-4">
								 <input class="form-control" name="ntcCreateTime" id="ntcCreateTime" type="text" readonly="readonly" />
							  </div>
						   </div>
						   <div class="form-group form-group-sm ">
