...
window.operateEvents = {
	'click #a_check' : function(e, value, row, index) {
		...
		$("#verificationCode").val(row.verificationCode);
		$("#createDate").val(row.createDate);
		document.getElementById("createDateDiv").style.display="block";
...
function addNewClick() {
	...
	document.getElementById("createDateDiv").style.display="none";
	$('#myModal1').modal({
		backdrop : 'static',
		keyboard : false
	});	
