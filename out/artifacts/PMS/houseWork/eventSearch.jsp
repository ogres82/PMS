...
<script type="text/javascript" src="${ContextPath}/houseWork/eventSearch.js"></script>
								...
								<form id="myForm1" class="form-horizontal" role="form">
									...
									<fieldset id="basicInfo">
										...
										<div class="form-group form-group-sm ">
											...
											<div class="col-sm-3">
												<input class="form-control" id="event_title" type="text" width="70%" readonly="readonly" />
											</div>
									...
									<fieldset id="send" style="display:">
										...
										<div class="form-group form-group-sm ">
											...
											<div class="col-sm-11">
												<textarea rows="3" id="handle_content" style="height: 60px" class="form-control validate[required]" placeholder="描述必填" disabled="disabled"></textarea>
											</div>
										</div>
										...
										<div class="form-group form-group-sm ">
											...
											<div class="col-sm-3">
												<input class="form-control "  id="arrv_time" type="text" disabled="disabled" readonly="readonly" />
											</div>
											<label class="col-sm-1 control-label">家政费用</label>
											<div class="col-sm-3">
												<input class="form-control" id="houseKeepingPay" type="text" onblur="this.value=outputmoney(this.value);" readonly="readonly" />
											</div>
									...
									<fieldset id="hfdetail">
										...
										<div class="form-group form-group-sm ">
											...
											<div class="col-sm-11">
												<textarea class="form-control" rows="3" id="visit_levContent" style="height: 60px" disabled="disabled"></textarea>
											</div>
										</div>
										<div class="form-group form-group-sm ">
											<label class="col-sm-1 control-label">回访记录</label>
											<div class="col-sm-11">
												<textarea class="form-control" rows="3" id="visit_content" style="height: 60px" disabled="disabled"></textarea>
											</div>
										</div>
										<div class="form-group form-group-sm ">
											<label class="col-sm-1 control-label">回访评级</label>
											<div class="col-sm-3">
												<select class="form-control" id="visit_evaluate" disabled="disabled">
													<option>--请选择--</option>
												</select>
											</div>
											<label class="col-sm-1 control-label">回访录音</label>
											<div class="col-sm-3">
												<input class="form-control" id="visit_record" type="text" disabled="disabled" readonly="readonly" />
											</div>
											<label class="col-sm-1 control-label">回访来源</label>
											<div class="col-sm-3">
												<select class="form-control" id="visit_from" disabled="disabled">
													<option>--请选择--</option>
												</select>
											</div>
										</div>
