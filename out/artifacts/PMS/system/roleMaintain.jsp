...
<script type="text/javascript" src="${ContextPath}/system/roleMaintain.js"></script>
	    ...
	    <div style="width:100%;height:55px;background-color:#f3f3f4;position:fixed;left:0;top:0;padding:0 10px;z-index:1000">
			<div class="row">
		   		<div  class="col-md-6" style="float:left;margin-top:10px;" id="topToolbar">
		    		 ...
		    		 <button id="btn_del" class="btn btn-primary" disabled type="button"><i class="fa fa-trash-o"></i> 删除</button>
		   	    </div>
		   	</div>
	   	</div>
