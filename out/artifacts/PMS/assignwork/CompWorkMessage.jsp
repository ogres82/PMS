...
<script type="text/javascript" src="${ContextPath}/assignwork/CompWorkMessage.js">
</script>
						...
						<div class="tab-content">
		          			<div id="tab-1" class="tab-pane active">
		          				...
		          				<form id="myForm2" class="form-horizontal" role="form">
									  ...
									  <fieldset id="tsdetail" style="display:">
											 ...
											 <div class="form-group form-group-sm " id="handleIds">
											  ...
											  <div class="col-sm-3">
													<div class="input-group">
													   <input type="text" class="form-control validate[required]" id="comp_operator_id"  style="display:none" />
													   <input type="text" class="form-control validate[required]" id="deptName"  style="display:none">
													   <input type="text" class="form-control validate[required]" placeholder="" id="comp_operator_username" >
