...
function(e) {
    ...
    p = {
        ...
        unset: function(e, t) {
            var i = p.count(e);
            if (i) {
                if (1 === i) return p.data[e].content = [],
                p.data[e].config = [],
                void(p.data[e].tags = []);
    ...
    E = '<div id="' + i + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + i + 'Label"></div>',
    ...
    I = " <br><samp>({sizeText})</samp>",
    S = '<div class="file-thumbnail-footer">\n    <div class="file-footer-caption" title="{caption}">{caption}{size}</div>\n    {progress} {actions}\n</div>',
    P = '<div class="file-actions">\n    <div class="file-footer-buttons">\n        {upload} {delete} {zoom} {other}    </div>\n    {drag}\n    <div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>\n    <div class="clearfix"></div>\n</div>',
    D = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n',
    z = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">{uploadIcon}</button>',
    A = '<button type="button" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>',
    U = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>',
    ...
    ee = ["image", "html", "text", "video", "audio", "flash", "object"],
    ie = {
        image: {
            width: "auto",
            height: "160px"
    ...
    ge = function(t, i) {
        var a = this;
        a.$element = e(t),
        a._validate() && (a.isPreviewable = f(), a.isIE9 = s(9), a.isIE10 = s(10), a.isPreviewable || a.isIE9 ? (a._init(i), a._listen()) : a.$element.removeClass("file-loading"))
    },
    ge.prototype = {
        constructor: ge,
        _init: function(t) {
            ...
            a.uploadFileAttr = ne(n.attr("name")) ? "file_data": n.attr("name"),
            a.reader = null,
            a.formdata = {},
            a.clearStack(),
            a.uploadCount = 0,
            ...
            ne(a.$element.attr("id")) && a.$element.attr("id", le()),
            ...
            a.$captionContainer = te(t, "elCaptionContainer", a.$container.find(".file-caption")),
            a.$caption = te(t, "elCaptionText", a.$container.find(".file-caption-name")),
            a.$previewContainer = te(t, "elPreviewContainer", a.$container.find(".file-preview")),
            a.$preview = te(t, "elPreviewImage", a.$container.find(".file-preview-thumbnails")),
            a.$previewStatus = te(t, "elPreviewStatus", a.$container.find(".file-preview-status")),
            a.$errorContainer = te(t, "elErrorContainer", a.$previewContainer.find(".kv-fileinput-error")),
        ...
        _addError: function(e) {
            var t = this,
            i = t.$errorContainer;
            e && i.length && (i.html(t.errorCloseButton + e), c(i.find(".kv-error-close"), "click",
            function() {
                i.fadeOut("slow")
            }))
        },
        ...
        _parseError: function(t, i, a) {
            ...
            n.showAjaxErrorDetails && l ? (l = e.trim(l.replace(/\n\s*\n/g, "\n")), l = l.length > 0 ? "<pre>" + l + "</pre>": "", r += o + l) : r += o,
            n.cancelling = !1,
            a ? "<b>" + a + ": </b>" + r: r
        },
        _parseFileType: function(e) {
            var t, i, a, n, r = this;
            for (n = 0; n < ee.length; n += 1) if (a = ee[n], t = oe(a, r.fileTypeSettings, ae[a]), i = t(e.type, e.name) ? a: "", !ne(i)) return i;
            return "other"
        },
        _parseFilePreviewIcon: function(t, i) {
            var a, n = this,
            r = n.previewFileIcon;
            return i && i.indexOf(".") > -1 && (a = i.split(".").pop(), n.previewFileIconSettings && n.previewFileIconSettings[a] && (r = n.previewFileIconSettings[a]), n.previewFileExtSettings && e.each(n.previewFileExtSettings,
            function(e, t) {
        ...
        _listen: function() {
            ...
            c(t.$btnFile, "click", e.proxy(t._browse, t)),
            c(a, "reset", e.proxy(t.reset, t)),
            c(n.find(".fileinput-remove:not([disabled])"), "click", e.proxy(t.clear, t)),
            c(n.find(".fileinput-cancel"), "click", e.proxy(t.cancel, t)),
            t._initDragDrop(),
            t.isUploadable || c(a, "submit", e.proxy(t._submitForm, t)),
            c(t.$container.find(".fileinput-upload"), "click", e.proxy(t._uploadClick, t)),
            c(e(window), "resize",
            function() {
                t._listenFullScreen(screen.width === window.innerWidth && screen.height === window.innerHeight)
            }),
            c(e(document), "webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange",
            function() {
        ...
        _zoneDragEnter: function(t) {
            ...
            i.isDisabled || !a ? (t.originalEvent.dataTransfer.effectAllowed = "none", void(t.originalEvent.dataTransfer.dropEffect = "none")) : void v(i.$dropZone, "file-highlighted")
        },
        ...
        _zoneDrop: function(e) {
            var t = this;
            e.preventDefault(),
            t.isDisabled || ne(e.originalEvent.dataTransfer.files) || (t._change(e, "dragdrop"), t.$dropZone.removeClass("file-highlighted"))
        },
        ...
        _listenModalEvent: function(e) {
            ...
            function(n) {
                ...
                "shown" === e && (o.removeClass("active").attr("aria-pressed", "false"), r.removeClass("active").attr("aria-pressed", "false"), i.hasClass("file-zoom-fullscreen") && (t._maximizeZoomDialog(), ue() ? r.addClass("active").attr("aria-pressed", "true") : o.addClass("active").attr("aria-pressed", "true")))
            })
        },
        _initZoom: function() {
            var t, a = this,
        ...
        _resizeZoomDialog: function(e) {
            ...
            if (i.hasClass("file-zoom-fullscreen")) fe(!1),
        ...
        _setZoomContent: function(t, i) {
            ...
            r = a.length ? a.html() : "",
            o = t.find(".file-footer-caption").text() || "",
            m.find(".kv-zoom-title").html(o),
            l = m.find(".kv-zoom-body"),
            i ? (p = l.clone().insertAfter(l), l.html(r).hide(), p.fadeOut("fast",
            function() {
                l.fadeIn("fast"),
                p.remove()
            })) : l.html(r),
            d = u.previewZoomSettings[n],
            d && (s = l.find(".kv-preview-data"), v(s, "file-zoom-detail"), e.each(d,
            function(e, t) {
                s.css(e, t),
                ...
                if (!ne(r) && void 0 !== o) {
                    ...
                    l = e.extend(!0, {},
                    {
                        ...
                        beforeSend: function(e) {
                            t.ajaxAborted = !1,
                            t._raise("filepredelete", [o, e, u]),
                            t.ajaxAborted ? e.abort() : (v(f, "file-uploading"), v(n, "disabled"))
                        },
                        success: function(e, i, r) {
                            var l, d;
                            return ne(e) || ne(e.error) ? (p.unset(t.id, g), l = p.count(t.id), d = l > 0 ? t._getMsgSelected(l) : "", t._raise("filedeleted", [o, r, u]), t._setCaption(d), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow",
                            function() {
                                t._clearObjects(f),
                                f.remove(),
                                a(),
                                l || 0 !== t.getFileStack().length || (t._setCaption(""), t.reset())
        ...
        _resetPreview: function() {
            var e, t, i = this;
            p.count(i.id) ? (e = p.out(i.id), i.$preview.html(e.content), t = i.initialCaption ? i.initialCaption: e.caption, i._setCaption(t)) : (i._clearPreview(), i._initCaption()),
        ...
        _initXhr: function(e, t, i) {
            ...
            function(e) {
                ...
                o = e.total;
                e.lengthComputable && (n = Math.ceil(r / o * 100)),
        ...
        _initUploadSuccess: function(t, i, a) {
            ...
            function() {
                l.fadeIn("slow").css("display:inline-block"),
        ...
        _uploadSingle: function(t, i, a) {
            ...
            g.formdata = w,
            g.showPreview && (r = e("#" + _ + ":not(.file-preview-initial)"), l = r.find(".kv-file-upload"), s = r.find(".kv-file-remove"), e("#" + _).find(".file-thumb-progress").removeClass("hide")),
            0 === h || !b || l && l.hasClass("disabled") || g._abort(C) || (m = function(e, t) {
            ...
            o = function() {
                ...
                g.fileBatchCompleted && setTimeout(function() {
                    g.showPreview && (p.set(g.id, e.content, e.config, e.tags, e.append), g.hasInitData && (g._initPreview(), g._initPreviewActions())),
                    g.unlock(),
                    g._clearFileInput(),
            ...
            d = function(i) {
                ...
                g.showPreview && (r.hasClass("file-preview-success") || (g._setThumbStatus(r, "Loading"), v(r, "file-uploading")), l.attr("disabled", !0), s.attr("disabled", !0)),
                a || g.lock(),
                g._raise("filepreupload", [n, _, t]),
                e.extend(!0, C, n),
            ...
            u = function() {
                setTimeout(function() {
                    g.showPreview && (l.removeAttr("disabled"), s.removeAttr("disabled"), r.removeClass("file-uploading")),
                    a ? o() : (g.unlock(!1), g._clearFileInput()),
        ...
        _uploadBatch: function() {
            ...
            t = function(t) {
                ...
                o.showPreview && o._getThumbs().each(function() {
                    ...
                    t.hasClass("file-preview-success") || (o._setThumbStatus(t, "Loading"), v(t, "file-uploading")),
                    i.attr("disabled", !0),
                    a.attr("disabled", !0)
                }),
                o._raise("filebatchpreupload", [i]),
                o._abort(i) && (t.abort(), o._setProgressCancelled())
            },
            i = function(t, i, a) {
                ...
                ne(t) || ne(t.error) ? (o._raise("filebatchuploadsuccess", [n]), r(), o.showPreview ? (l.each(function() {
                    ...
                    a.removeAttr("disabled"),
                    i.removeAttr("disabled"),
                    0 === d.length ? void o._setPreviewError(t) : ( - 1 !== e.inArray(s, d) ? o._setPreviewError(t) : (t.find(".kv-file-upload").hide(), o._setThumbStatus(t, "Success"), o.updateStack(s, void 0)), void s++)
            ...
            a = function(t, i, a) {
                ...
                r = o._parseError(t, a);
                o._showUploadError(r, n, "filebatchuploaderror"),
                o.uploadFileCount = s - 1,
                o.showPreview && (o._getThumbs().each(function() {
                    var t = e(this),
        ...
        _initFileActions: function() {
            ...
            t.showPreview && (t._initZoomButton(), t.$preview.find(".kv-file-remove").each(function() {
                ...
                c(o, "click",
                function() {
                    return r = t._raise("filepreremove", [s, d]),
                    r !== !1 && t._validateMinCount() ? (i = l.hasClass("file-preview-error"), ce(l), void l.fadeOut("slow",
                    function() {
                        ...
                        t._clearFileInput(),
                        0 !== o || 0 !== c || u ? (a = c + o, n = a > 1 ? t._getMsgSelected(a) : r[0] ? t._getFileNames()[0] : "", t._setCaption(n)) : t.reset(),
        ...
        _previewDefault: function(t, i, a) {
            ...
            if (n.showPreview) {
                ...
                l.length || (l = e(document.createElement("div")).addClass("file-live-thumbs").appendTo(r)),
                l.append("\n" + s),
        ...
        _previewFile: function(t, i, a, n, r) {
            if (this.showPreview) {
                ...
                "html" === s && l.purifyHtml && window.DOMPurify && (v = window.DOMPurify.sanitize(v)),
                m || h ? (o = l._generatePreviewTemplate(s, v, d, i.type, n, !1, i.size), l._clearDefaultPreview(), g.append("\n" + o), l._validateImage(t, n, c, i.type)) : l._previewDefault(i, n),
                l._initSortable()
            }
        },
        ...
        _readFiles: function(t) {
            ...
            _ = function(n, r, o, l) {
                ...
                return a._previewDefault(r, o, !0),
                ...
                100),
                a._initFileActions(),
                a.removeFromPreviewOnError && e("#" + o).remove(),
            ...
            i = function(e) {
                if (ne(n.attr("multiple")) && (m = 1), e >= m) return a.isUploadable && a.filestack.length > 0 ? a._raise("filebatchselected", [a.getFileStack()]) : a._raise("filebatchselected", [t]),
                ...
                Z = ne(L) ? "": L.join(", ");
                if (ne(L) || (D = new RegExp("\\.(" + L.join("|") + ")$", "i")), P = P.toFixed(2), a.maxFileSize > 0 && P > a.maxFileSize) return T = a.msgSizeTooLarge.replace("{name}", S).replace("{size}", P).replace("{maxSize}", a.maxFileSize),
                void(a.isError = _(T, I, $, e));
                if (!ne(U) && re(U)) {
                    for (y = 0; y < U.length; y += 1) F = U[y],
                    x = g[F],
                    E = void 0 !== x && x(I.type, S),
                    A += ne(E) ? 0 : E.length;
                    if (0 === A) return T = a.msgInvalidFileType.replace("{name}", S).replace("{types}", j),
                    void(a.isError = _(T, I, $, e))
                }
                ...
                s.onload = function(t) {
                    a._previewFile(e, I, t, $, z),
                    a._initFileActions()
                },
                s.onloadend = function() {
                    T = u.replace("{index}", e + 1).replace("{files}", m).replace("{percent}", 50).replace("{name}", S),
                    setTimeout(function() {
                        c.html(T),
                    ...
                    100),
                    a._raise("fileloaded", [I, $, e, s])
                },
                s.onprogress = function(t) {
                    if (t.lengthComputable) {
                        var i = t.loaded / t.total * 100,
                        a = Math.ceil(i);
                        T = u.replace("{index}", e + 1).replace("{files}", m).replace("{percent}", a).replace("{name}", S),
                        setTimeout(function() {
                            c.html(T)
                        },
                        100)
        ...
        _setThumbStatus: function(e, t) {
            ...
            if (i.showPreview) {
                ...
                "Success" === t && (e.find(".file-drag-handle").remove(), o.css("margin-left", 0)),
                o.html(l[a]),
                o.attr("title", l[n]),
                e.addClass(r)
            }
        ...
        _setProgress: function(e, t, i) {
            ...
            t = t || a.$progress,
            ne(r) || (t.html(r.replace(/\{percent}/g, n)), i && t.find('[role="progressbar"]').html(i))
        },
        _setFileDropZoneTitle: function() {
            var e = this,
            t = e.$container.find(".file-drop-zone");
            t.find("." + e.dropZoneTitleClass).remove(),
            e.isUploadable && e.showPreview && 0 !== t.length && !(e.getFileStack().length > 0) && e.dropZoneEnabled && (0 === t.find(".file-preview-frame").length && ne(e.defaultPreviewContent) && t.prepend('<div class="' + e.dropZoneTitleClass + '">' + e.dropZoneTitle + "</div>"), e.$container.removeClass("file-input-new"), v(e.$container, "file-input-ajax-new"))
        },
        ...
        _getFileCount: function(e) {
            var t = this,
            i = 0;
            return t.validateInitialCount && !t.overwriteInitial && (i = p.count(t.id), e += i),
            e
        },
        ...
        _checkDimensions: function(e, t, i, a, n, r, o) {
            var l, s, d, c, p = this,
            u = "Small" === t ? "min": "max",
            f = p[u + "Image" + r]; ! ne(f) && i.length && (d = i[0], s = "Width" === r ? d.naturalWidth || d.width: d.naturalHeight || d.height, c = "Small" === t ? s >= f: f >= s, c || (l = p["msgImage" + r + t].replace("{name}", n).replace("{size}", f), p._showUploadError(l, o), p._setPreviewError(a, e, null)))
        },
        _validateImage: function(e, t, i, a) {
            ...
            function() {
                r = p.width(),
                l = d.width(),
                r > l && (u.css("width", "100%"), p.css("width", "97%")),
                n = {
                    ind: e,
                    id: t
                },
        ...
        _validateAllImages: function() {
            ...
            if (l.loadedImages.length === l.totalImagesCount && (l._raise("fileimagesloaded"), l.resizeImage)) {
                for (o = l.isUploadable ? l._showUploadError: l._showError, e = 0; e < l.loadedImages.length; e++) t = l.loadedImages[e],
                i = t.img,
                a = t.thumb,
                n = t.pid,
                r = t.ind,
        ...
        _getResizedImage: function(e, t, i, a) {
            ...
            if (!u) return ! 1;
            if (l === c && s === p) return ! 0;
            t = t || o.resizeDefaultImageType,
            n = l > c,
            r = s > p,
            d = "width" === o.resizePreference ? n ? c / l: r ? p / s: 1 : r ? p / s: n ? c / l: 1,
            o._resetCanvas(),
            l *= d,
            s *= d,
            f.width = l,
            f.height = s;
            try {
                return m.drawImage(e, 0, 0, l, s),
                f.toBlob(function(e) {
                    o._raise("fileimageresized", [i, a]),
                    o.filestack[a] = e
                },
                t, o.resizeQuality),
                !0
        ...
        _setCaption: function(t, i) {
            ...
            s = l.getFileStack();
            if (l.$caption.length) {
                if (i) a = e("<div>" + l.msgValidationError + "</div>").text(),
                r = s.length,
                o = r ? 1 === r && s[0] ? l._getFileNames()[0] : l._getMsgSelected(r) : l._getMsgSelected(l.msgNo),
                n = '<span class="' + l.msgValidationErrorClass + '">' + l.msgValidationErrorIcon + (ne(t) ? o: t) + "</span>";
                else {
                    if (ne(t)) return;
                    a = e("<div>" + t + "</div>").text(),
                    n = l._getLayoutTemplate("fileIcon") + a
                }
                l.$caption.html(n),
                l.$caption.attr("title", a),
                l.$captionContainer.find(".file-caption-ellipsis").attr("title", a)
            }
        },
        ...
        _renderButton: function(e) {
            ...
            ne(o) || (o = ' <span class="' + t.buttonLabelClass + '">' + o + "</span>"),
            i.replace("{type}", s).replace("{css}", a).replace("{title}", n).replace("{status}", l).replace("{icon}", r).replace("{label}", o)
        },
        ...
        _renderFileActions: function(e, t, i, a, n, r, o, l) {
            ...
            return t && (u = d._getLayoutTemplate("actionDelete").replace(/\{removeClass}/g, _).replace(/\{removeIcon}/g, h.removeIcon).replace(/\{removeTitle}/g, h.removeTitle).replace(/\{dataUrl}/g, c).replace(/\{dataKey}/g, p)),
        ...
        _change: function(t) {
            ...
            if (i.reader = null, i._resetUpload(), i._hideFileIcon(), i.isUploadable && i.$container.find(".file-drop-zone ." + i.dropZoneTitleClass).remove(), c) for (n = []; m[f];) l = m[f],
            l.type || l.size % 4096 !== 0 ? n.push(l) : w++,
            f++;
            else n = void 0 === t.target.files ? t.target && t.target.value ? [{
                name: t.target.value.replace(/^.+\\/, "")
            }] : [] : t.target.files;
            if (ne(n) || 0 === n.length) return u || i.clear(),
            ...
            if (i._resetErrors(), d = n.length, o = i._getFileCount(i.isUploadable ? i.getFileStack().length + d: d), i.maxFileCount > 0 && o > i.maxFileCount) {
                if (!i.autoReplace || d > i.maxFileCount) return s = i.autoReplace && d > i.maxFileCount ? d: o,
                r = i.msgFilesTooMany.replace("{m}", i.maxFileCount).replace("{n}", s),
                i.isError = _(r, null, null, null),
        ...
        clear: function() {
            ...
            }), i.isUploadable && (p.data[i.id] = {}), i.$preview.html(""), t = !i.overwriteInitial && i.initialCaption.length > 0 ? i.initialCaption: "", i._setCaption(t), i.$caption.attr("title", ""), v(i.$container, "file-input-new"), i._validateDefaultPreview()),
        ...
        upload: function() {
            ...
            if (n.isUploadable && !n.isDisabled && (0 !== r || l)) {
                ...
                n.uploadLog = [], n.lock(), n._setProgress(2), 0 === r && l) return void n._uploadExtraOnly();
    ...
    e.fn.fileinput = function(t) {
        if (f() || s(9)) {
            ...
            switch (i.shift(), this.each(function() {
                ...
                o || (s && (c = e.fn.fileinputThemes[s] || {}), "en" === p || ne(e.fn.fileinputLocales[p]) || (d = e.fn.fileinputLocales[p] || {}), n = e.extend(!0, {},
                e.fn.fileinput.defaults, c, e.fn.fileinputLocales.en, d, l, r.data()), o = new ge(this, n), r.data("fileinput", o)),
                "string" == typeof t && a.push(o[t].apply(o, i))
            }), a.length) {
            case 0:
                return this;
            case 1:
    ...
    e.fn.fileinputLocales.en = {
        ...
        msgFilesTooMany: "只能上传 <b>{m}</b>个文件.",
